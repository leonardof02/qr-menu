...
export default function PriceInput({ value, name, placeholder, onChange, label }: PriceInputProps) {
    ...
    return <div className="flex flex-col">
        ...
        <input {...{ value, name, placeholder, onChange}} id={name} type="number" min="0"
